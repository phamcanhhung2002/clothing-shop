...
import { addProduct, subProduct } from "../redux/cartRedux";
...
const Cart = () => {
  ...
  useEffect(() => {
    const makeRequest = async () => {
      try {
        const res = await userRequest.post("/checkout/charge", {
              ...
              <Product key={product.id}>
                ...
                <PriceDetail>
                  <ProductAmountContainer>
                    <Add
                      onClick={() =>
                        handleQuantity("dec", { ...product, quantity: 1 })
                      }
                    />
                    <ProductAmount>{product.quantity}</ProductAmount>
                    <Remove
                      onClick={() =>
                        handleQuantity("inc", { ...product, quantity: 1 })
                      }
                    />
                  </ProductAmountContainer>
                  <ProductPrice>
